...
.PARAMETER AppNames
    ...
    should be registered as Dataverse Application Users (e.g., "app-re2-api-dev,app-re2-web-dev,func-re2-compliance-dev").
...
.EXAMPLE
    ...
    ./provision-dataverse-schema.ps1 -DataverseUrl "https://org.crm4.dynamics.com" -ResourceGroupName "rg-re2-dev" -AppNames "app-re2-api-dev,app-re2-web-dev,func-re2-compliance-dev"
#>
