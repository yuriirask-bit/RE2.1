...
public class DataverseCustomerRepository : ICustomerRepository
{
    ...
    private CustomerComplianceExtensionDto MapToDto(Entity entity)
    {
        return new CustomerComplianceExtensionDto
        {
            ...
            phr_businesscategory = entity.GetAttributeValue<OptionSetValue>("phr_businesscategory")?.Value ?? 0,
            phr_approvalstatus = entity.GetAttributeValue<OptionSetValue>("phr_approvalstatus")?.Value ?? 0,
            phr_gdpqualificationstatus = entity.GetAttributeValue<OptionSetValue>("phr_gdpqualificationstatus")?.Value ?? 0,
