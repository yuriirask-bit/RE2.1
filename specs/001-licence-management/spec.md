...
- **GDP Site**: Represents a physical location for distribution activities. Key attributes: site name, address, site type (warehouse/cross-dock/transport hub), WDA/GDP certificate references, permitted GDP activities (storage >72h/temperature-controlled/outsourced/transport-only), inspection history. Relationships: covered by one or more WDAs, has multiple Inspections, linked to SOPs, linked to Staff Training Records, used in Transactions.
...
**Licence & Customer Qualification Efficiency:**
...
**Audit & Reporting Responsiveness:**
...
**GDP Partner Qualification & Monitoring:**
